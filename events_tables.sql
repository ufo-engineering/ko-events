...
--
-- Table structure for table `action_handlers`
--

DROP TABLE IF EXISTS `action_handlers`;
...
--
-- Dumping data for table `action_handlers`
--

LOCK TABLES `action_handlers` WRITE;
/*!40000 ALTER TABLE `action_handlers` DISABLE KEYS */;
/*!40000 ALTER TABLE `action_handlers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-20 11:53:05
